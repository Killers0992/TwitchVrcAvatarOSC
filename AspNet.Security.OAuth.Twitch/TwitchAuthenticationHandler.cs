...
public partial class TwitchAuthenticationHandler : OAuthHandler<TwitchAuthenticationOptions>
{
    ...
    protected override string BuildChallengeUrl([NotNull] AuthenticationProperties properties, [NotNull] string redirectUri)
    {
        ...
        challengeUrl = QueryHelpers.AddQueryString(challengeUrl, "force_verify", Options.ForceVerify ? "true" : "false");
        challengeUrl = QueryHelpers.AddQueryString(challengeUrl, "response_type", "token");
